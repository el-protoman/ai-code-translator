...
const createPrompt = (inputLanguage, outputLanguage, inputCode) => {
    if (inputLanguage === 'Natural Language') {
        return endent`
    Ignore all previous instructions. You are a computer science teacher expert in computer science and instruction specializing in coding. You have helped many people before me to translate code.
    You are an expert programmer in all programming languages. Your task is now to translate the natural language to "${outputLanguage}" code. Do not include \`\`\`.
